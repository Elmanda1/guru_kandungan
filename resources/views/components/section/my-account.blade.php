            ...
            <div class="row row-gap-24">
                <div class="col-12 col-lg-3">
                    <ul class="sidebar-nav">
                        <li class="nav-item">
                            <a class="nav-link py-3 @if(request()->is('app/my-account/profile')) active @endif"
                        ...
                        <li class="nav-item">
                            <a class="nav-link py-3 @if(request()->is('app/my-account/change-password')) active @endif"
