    ...
    <div class="container">
        ...
        <div class="offcanvas offcanvas-start border-0" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-header align-items-center justify-content-between shadow-bottom"
                ...
                <button type="button" class="btn no-outline px-0 text-white" data-coreui-dismiss="offcanvas">
            ...
            <div class="offcanvas-body" style="min-height: 92px">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link p-3 {{ request()->routeIs('home') ? 'active' : '' }}"
                            href="{{ route('home') }}">
                            {{ __('Beranda') }}
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link p-3 {{ request()->routeIs('user-guide') ? 'active' : '' }}"
                ...
                <ul id="login-nav" class="navbar-nav justify-content-end flex-grow-1 mt-5 mt-lg-0">
                    @if(auth()->user() && auth()->user()->hasVerifiedEmail())
                        <li class="nav-item dropdown d-none d-lg-flex align-items-center justify-content-center">
                            <a class="nav-link p-0 bg-transparent" data-coreui-toggle="dropdown" href="#" role="button"
