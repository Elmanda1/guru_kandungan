...
@section('content')
                            ...
                            @if(!empty($departments) && $departments->count() > 0)
                                @foreach($departments as $index => $department)
                                    <tr class="align-middle">
                                        <th class="text-nowrap text-center">{{ $index + $departments->firstItem() }}</th>
            ...
            <div class="modal-content">
                <form action="{{ route('department.store') }}" method="post">
                    ...
                    <div class="modal-header border-0">
                        <h5 class="modal-title" id="createModalLabel">{{ __('Add Department') }}</h5>
    ...
    @php $department = session('department') @endphp
    @if($department != null)
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form action="{{ route('department.update', $department) }}" method="post">
                        ...
                        <div class="modal-header border-0">
                            <h5 class="modal-title" id="editModalLabel">{{ __('Department') }}</h5>
