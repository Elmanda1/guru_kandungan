<nav class="navbar fixed-top navbar-expand-lg p-lg-0 shadow-bottom bg-warning" style="min-height: 64px">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-2 d-none d-lg-block py-3" href="<?php echo e(url()->current()); ?>"
           style="margin-right: 120px">
            <img src="<?php echo e(asset('assets/images/logo-with-text.png')); ?>" alt="" height="60">
        </a>
            ...
            <ul class="header-nav d-lg-none">
                <li class="nav-item dropdown">
                    <a class="nav-link p-0 rounded-circle bg-transparent" data-coreui-toggle="dropdown" href="#"
                       ...
                       aria-haspopup="true"
                       aria-expanded="false">
                        <img class="avatar avatar-md" src="<?php echo e(auth()?->user()?->getPhotoUrl()); ?>" alt="Photo Profile">
                    </a>
                    <div class="dropdown-menu dropdown-menu-end pt-0 mt-3">
                        ...
                        <?php if(auth()->user()->isRegistrationComplete()): ?>
                            <?php if(auth()->user()->isProfileComplete()): ?>
                                <a class="dropdown-item small" href="<?php echo e(route('my-home')); ?>">
                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'pb-1','height' => '24','width' => '24']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'pb-1','width' => '24','height' => '24']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                            ...
                            <?php else: ?>
                                <a class="dropdown-item small" href="<?php echo e(route('auth.profile-completion')); ?>">
                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('heroicon-o-user'); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                    <?php echo e(__('Profile Completion')); ?>

                                </a>
                            <?php endif; ?>
                        <?php else: ?>
                            <a class="dropdown-item small" href="<?php echo e(route('auth.registration-completion')); ?>">
                                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('heroicon-o-user'); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                <?php echo e(__('Registration Completion')); ?>
        ...
        <div class="offcanvas offcanvas-start border-0" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-header align-items-center justify-content-between shadow-bottom"
                ...
                <a class="navbar-brand d-flex align-items-center gap-2" href="#">
                    <img class="d-none d-lg-block" src="<?php echo e(asset('assets/images/logo-with-text.png')); ?>" alt=""
                         height="60">
                    <img class="d-lg-none" src="<?php echo e(asset('assets/images/logo-with-yellow-text.png')); ?>" alt=""
                         height="60">
                </a>
                <button type="button"
                    ...
                    <?php if(auth()->user() && auth()->user()->hasVerifiedEmail()): ?>
                        <li class="nav-item dropdown d-none d-lg-flex align-items-center justify-content-center">
                            <a class="nav-link p-0 bg-transparent" data-coreui-toggle="dropdown" href="#"
                               ...
                               aria-haspopup="true"
                               aria-expanded="false">
                                <img class="avatar avatar-md" src="<?php echo e(auth()?->user()?->getPhotoUrl()); ?>"
                                     alt="Photo Profile">
                                <?php if(auth()?->user()?->name): ?>
                                    <small
                                        class="ms-2 d-none d-lg-inline"><?php echo e(Str::limit(auth()?->user()?->name, 20, '')); ?></small>
                                <?php else: ?>
                                    <small
                                        class="ms-2 d-none d-lg-inline"><?php echo e(Str::limit(auth()?->user()?->email, 20, '')); ?></small>
                                <?php endif; ?>
                            </a>
                        ...
                        <?php if(auth()->user()->isRegistrationComplete()): ?>
                            <?php if(auth()->user()->isProfileComplete()): ?>
                                <li class="nav-item d-lg-none">
                                    <a class="nav-link p-3 <?php echo e(request()->is('auth/login') ? 'active' : ''); ?>"
...
<?php endif; ?>
                            ...
                            <?php else: ?>
                                <li class="nav-item d-lg-none">
                                    <a class="nav-link p-3 <?php echo e(request()->is('auth/login') ? 'active' : ''); ?>"
                                       href="<?php echo e(route('auth.profile-completion')); ?>">
                                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('heroicon-o-user'); ?>
...
<?php endif; ?>
                        ...
                        <?php else: ?>
                            <li class="nav-item d-lg-none">
                                <a class="nav-link p-3 <?php echo e(request()->is('auth/login') ? 'active' : ''); ?>"
                                   href="<?php echo e(route('auth.registration-completion')); ?>">
                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('heroicon-o-user'); ?>
...
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('heroicon-m-arrow-right-start-on-rectangle'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(BladeUI\Icons\Components\Svg::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php /**PATH /home/rafif-arka/Projects/guru_kandungan/resources/views/layouts/default/navbar.blade.php ENDPATH**/ ?>